...
# This code is used to generate a graph for the average active power or energy of the given
# inverters over a time interval.

import pandas as pd
import matplotlib.pyplot as plt
import matplotlib.dates as mdates

# display graph of given converters
def showAvgs(filepath, first, last):
