...
# This code is used to create a csv file of the average irradiance per month.
...
avg_csv = pd.read_csv(f'Data_Analysis\{monthYear}APAvgs.csv', index_col=1)
...
avg_csv.to_csv(f'Data_Analysis\{monthYear}APAvgs.csv', index=False)